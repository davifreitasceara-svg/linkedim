      ...
      >
        ...
        <div className="text-center mb-8">
          <div className="w-16 h-16 rounded-2xl bg-primary flex items-center justify-center mx-auto mb-4">
            <span className="text-primary-foreground font-bold text-2xl font-[Space_Grotesk]">P</span>
          </div>
          <h1 className="text-3xl font-bold text-foreground font-[Space_Grotesk]">ProConnect</h1>
          <p className="text-muted-foreground mt-2">Sua rede profissional com portfólio</p>
        </div>
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription>
              {isLogin ? "Acesse sua conta profissional" : "Comece a mostrar seu trabalho"}
            </CardDescription>
          </CardHeader>
